...
### Api
- [x] Проверка успешной авторизации
- [x] Проверка статуса и ответа при авторизации без пароля
- [x] Проверка статуса и ответа при авторизации без email
- [x] Проверка статуса и ответа при авторизации с некорректным паролем
- [x] Проверка статуса и ответа при авторизации с некорректным email
- [x] Проверка статуса и ответа при авторизации без атрибута system
- [x] Проверка статуса и ответа при авторизации без атрибута type_device
...
- [x] Проверка статуса и ответа при создании проекта без названия
- [x] Проверка статуса и ответа при создании проекта без атрибута uid
- [x] Проверка статуса и ответа при создании проекта без атрибута email_creator
...
### Графики
В разделе отображаются:
- круговая диаграмма распределения результатов тестов по статусам
...
### Тест-кейсы
Пример «живой документации»: тест-кейсы, сгенерированные на основе автотестов, с описанием шагов и разбиением на фичи и стори.
...
Интеграция `Jira` и `Allure TestOps` позволяет связать задачи и тестовую документацию, что упрощает отслеживание статуса тестирования в контексте задач и позволяет более эффективно управлять качеством продукта.
### Задача в  Jira 
